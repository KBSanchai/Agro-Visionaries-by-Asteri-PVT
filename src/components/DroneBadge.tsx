...
export const DroneBadge: React.FC<DroneBadgeProps> = ({ 
  ...
  return (
    <Link
      to={`/drone/${id}`}
      className="w-full flex items-center bg-white rounded-xl border border-gray-100 p-3 shadow-sm transition-all duration-300 hover:shadow-md group"
    >
      <div className="h-12 w-12 mr-3 overflow-hidden rounded-lg">
        <img
          src="/lovable-uploads/cb90b90a-fa77-455d-b897-e571e6952320.png"
          alt={name}
      ...
      <div className="flex items-center ml-2">
        {isActive && (
          <div className="mr-2 h-2 w-2 bg-green-500 rounded-full animate-pulse-soft" />
        )}
